  ...
  return (
    <div>
      ...
      <div className="wrapper wrap1">
            ...
            <div className="item-1 item2 item12"></div>
            <div className="item-1 item3 item12"></div>
            <div className="item-1 item4 item12"></div>
            <div className="item-1 item5 item12"></div>
            <div className="item-1 item6 item12"></div>
            <div className="item-1 item7 item12"></div>
            <div className="item-1 item8 item12"></div>
        </div>
